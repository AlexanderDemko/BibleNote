...
namespace BibleNote.Analytics.Services.ModulesManager.Scheme.ZefaniaXml
{
    ...
    public partial class BIBLEBOOK
    {
            ...
            out List<SimpleVersePointer> notFoundVerses, out List<SimpleVersePointer> emptyVerses)
        {
            ...
            {
                var verseContent = GetVerseContent(verse, moduleShortName, strongPrefix, false, out VerseIndex verseIndex,
                                        out bool localIsEmpty, out bool localIsFullVerse, out isPartOfBigVerse, out hasValueEvenIfEmpty);

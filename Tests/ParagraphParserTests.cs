...
lang=ru>&nbsp;Тим&nbsp;</span><span style='color:#444444' lang=en-US>2:2). </span>";
    ...
    ";
        ...
        public void Test52()
        {
            var input = "Слово, переведённое в 2Кор 9:7 как «расположение», имеет следующие значения: выбирать, избирать, предпочитать одно перед другим, что говорит об обдуманном, взвешенном решении, принятом в своей жизни. В некоторых церквах рекомендуют придерживаться следующего принципа: 10% – на поддержку церкви и заботу о нуждающихся, 10% – на сбережения, 80% – на всё остальное.";

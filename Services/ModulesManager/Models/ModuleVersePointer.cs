...
namespace BibleNote.Analytics.Services.ModulesManager.Models
{
    ...
    public class ModuleVersePointer : SimpleVersePointer
    {
        ...
        /// <summary>
        /// У нас есть стих в ibs (Лев 12:7). Ему по смыслу соответствуют два стиха из rst (Лев 12:7-8). Но поделить стих в ibs не получается, потому палочка стоит в конце стиха. Но это не значит, что восьмой стих пустой!
        /// </summary>
